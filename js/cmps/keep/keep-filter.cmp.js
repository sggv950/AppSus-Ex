export default {
    ...
    <section class="keep-filter">
        <select class="filter-select" v-model="filter.type" @change="emitFilter">
            <option value="">All</option>
            <option>text</option>
            <option>image</option>
            <option>todo</option>
        </select>
        <input class="filter-input" type="text" v-model="filter.keyword" @input="emitFilter" placeholder="search by keyword" /><br>
